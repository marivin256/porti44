...
function Body(){
    ...
    return(
        ...
        <img src={portimg} alt="image" id='pic' className='float-right rounded-full mb-6'/>
...
<  div className="text-4xl font-extrabold text-white sm:text-5xl md:text-6xl">I'm <span className="text-yellow-600">Tomusange<br/>Marvin</span></div>
